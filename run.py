...
class WebServer():
    ...
    def run(self) -> None:
        # Streamlit/Cloud environments ke liye debug=False zaroori hai
...
class RunBot():
    ...
    bot_file = "main"  # Ensure your main bot file is named main.py
    bot_class = "Bot"
    ...
    def run_loop(self) -> None:
        if not self.definitions:
            print("No bot definitions found. Exiting.")
            return

        while True:
            try:
                # Direct asyncio loop for better compatibility
